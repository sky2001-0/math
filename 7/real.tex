...
\thmf{$\R$は連結}{Rは連結}{
  ...
  $b \in V$とすると、$V$は開集合であるので$\exists \epsilon \in \R^+ \qty(\sqty{b - \epsilon, b + \epsilon} \subseteq V)$

  このとき$b - \epsilon$も$B_1$の上界となり矛盾。
  ゆえに$b \notin V$
  よって$b < v$である。

  $b \in U$とすると、$U$は開集合であるので$\exists \epsilon' \in \R^+ \qty(\sqty{b - \epsilon', b + \epsilon'} \subseteq U)$
