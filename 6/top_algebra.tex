...
\thm{順序群は位相群}{
  ...
  $G^+$が最小元$m$を持つとき、$\qty{x} = \sqty{x - m, x + m} \subseteq \sqty{a, b}$である。
  同様に$\qty{y} \subseteq \sqty{a, b}$でもある。
  ...
  ゆえに、$\varphi \qty(\sqty{x - g, x + g} \times \sqty{y - g, y + g}) \subseteq \sqty{a, b}$である。\\*
...
\thm{順序群の一様構造}{
  ...
  さらに、基本近縁系$\mathcal{V}$の定める近縁系$\mathcal{U'}$は、\thmref{位相群の左一様構造}の定める近縁系$\mathcal{U}$に一致する。
	...
	$\forall B \in \mathcal{B}(0_G)$について、$B = \sqty{a, b} \land a < 0_G < b$である。$g = \min \qty{-a, b} \in G^+$について、$V_g \subseteq \tilde{B}$である。
...
\thm{順序環は位相環}{
  ...
  $B' \coloneqq \sqty{-r, r} \times \sqty{-r, r} \mathcal{B} \times \mathcal{B}$であり、$\times(B') \subseteq B$\\*
  ...
  $r \coloneqq \min \qty{-a, b} / \abs{x_0}$について、$B' \coloneqq \sqty{-r, r}$であり、$f(B') \subseteq B$\\*
