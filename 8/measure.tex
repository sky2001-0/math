...
\lemf{$\sigma$-加法族の生成}{sigma-加法族の生成}{
  ...
  \eq*{
    \sigma(\mathcal{T}) \coloneqq \bigcap \qty{\mathcal{S} \in \P(\P(X)) \mid \text{$\mathcal{S}$は$\sigma$-加法族} \land \mathcal{T} \subseteq \mathcal{S}}
  }
}{
  $R \coloneqq \qty{\mathcal{S} \in \P(\P(X)) \mid \text{$\mathcal{S}$は$\sigma$-加法族} \land \mathcal{T} \subseteq \mathcal{S}}$とする。
...
\lem{可測の条件}{
  ...
  十分性は、$\mathcal{T'} \subseteq \mathcal{S'}$より明らか。\\*

  必要性を示す。

  $\mathcal{Q'} \coloneqq \qty{S' \in \mathcal{S'} \mid f^{-1}(S') \in \mathcal{S}}$を考える。
  $\mathcal{Q'} \subseteq \mathcal{S'}$である。
  ...
  定義より、$\mathcal{T'} \subseteq \mathcal{Q'}$であるので、$\mathcal{S'}$は$\mathcal{T'}$を含む最小の$\sigma$-加法族であるので、$\mathcal{S'} \subseteq \mathcal{Q'}$である。
...
\rem{拡大実関数}{
  写像$f \in Y^X$について、$Y \subseteq \bar{\R}$であるとき、$f$を関数、または拡大実関数と呼ぶことがある。
}
...
\lem{拡大実数への可測の特徴づけ}{
  ...
  \thmref{原像の性質}、\lemref{sigma-加法族の性質}より、$\forall a, b \in \R \qty(f^{-1}(\outsqbr{a, b}) = f^{-1}(\R_{> a} \cap \R_{< b}) = f^{-1}(\R_{> a}) \cap f^{-1}(\R_{< b}) \in \mathcal{S})$
  ...
  $5. \to 1.$を示す。
  \dfnref{順序空間}の定める開集合系$\mathcal{O}$について、$\R_{< a} \in \mathcal{O} \subseteq \mathcal{B}_\R$より明らか。
}
...
\thm{測度}{
  ...
  \begin{enumerate}
    \item $\displaystyle \forall A, B \in \mathcal{S} \qty(A \subseteq B \rightarrow \mu(A) \leq \mu(B))$
    \item $\displaystyle \forall \qty(S_n)_{n \in \N} \in \mathcal{S}^\N \qty(\mu \qty(\bigcup \qty{S_n \mid n \in \N}) \leq \sum_{n \in \N} \mu(S_n))$
    \item $\qty(\mathcal{S}, \subseteq)$上の広義単調増加列$\qty(S_n)_{n \in \N}$について、$\displaystyle \mu \qty(\bigcup \qty{S_n \mid n \in \N}) = \sup{\mu(S_n) \mid n \in \N}$
  \end{enumerate}
}{
  $1.$を示す。
