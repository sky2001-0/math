...
\rem{実関数}{
  写像$f \in Y^X$について、$Y \subseteq \R$であるとき、$f$を関数、または実関数と呼ぶことがある。
}
...
\thm{中間値の定理}{
  ...
  定義より、$y \in \outsqbr{f(x_1), f(x_2)}$

  $R_1 \coloneqq \qty{r \in \R \mid r < y}, R_2 \coloneqq \qty{r \in \R \mid y < r}$は開集合であり、$R_1 \cup R_2 \supseteq f(X) \land R_1 \cap R_2 = \varnothing$である。
