...
\dfn{集合算}{
  集合$X$と、集合$A, B \subset X \times X$について、以下で定める略記$A \circ B, A^{-1}$を考える。
  \eqg*{
...
\dfn{基本近縁系}{
  集合$X$について、以下を満たす集合系$\mathcal{V} \subset \P(X \times X)$を基本近縁系と呼ぶ。
  \eqg*{
    \mathcal{V} \neq \varnothing \\*
...
\lem{基本近縁系の三角性}{
  ...
  \eq*{
    \forall V \in \mathcal{V} \exists W \in \mathcal{V} \qty(W \cup W^{-1} \subset W^{-1} \circ W \subset \qty(W^{-1} \circ W) \circ W \subset V)
  }
}{
...
\dfn{近縁系}{
  ...
  \eq*{
    \mathcal{U} \coloneqq \qty{U \subset X \times X \mid \exists V \in \mathcal{V} \qty(V \subset U)}
  }
}

\lem{近縁系の一意性}{
  集合$X$の基本近縁系$\mathcal{V}$と集合系$\mathcal{V^\prime} \subset \P(X \times X)$について、以下を満たすとき、$\mathcal{V^\prime}$は基本近縁系である。
  \eqg*{
    \forall V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \qty(V \subset V^\prime) \\*
    \forall V \in \mathcal{V} \exists V^\prime \in \mathcal{V^\prime} \qty(V^\prime \subset V)
  }
  ...
  第二式を考える。$\forall V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \forall x \in X \qty(\qty(x, x) \in V \subset V^\prime)$より成り立つ。

  \vskip\baselineskip

  第三式を考える。仮定より$\forall V^\prime_1, V^\prime_2 \in \mathcal{V^\prime} \exists V_1, V_2 \in \mathcal{V} \qty(V_1 \cap V_2 \subset V^\prime_1 \cap V^\prime_2)$である。

  \dfnref{基本近縁系}第三式より$\exists V \in \mathcal{V} \qty(V \subset V_1 \cap V_2)$であり、仮定より$\exists V^\prime \in \mathcal{V^\prime} \qty(V^\prime \subset V \subset V^\prime_1 \cap V^\prime_2)$

  \vskip\baselineskip

  第四式を考える。$\forall V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \exists W \in \mathcal{V} \exists W^\prime \in \mathcal{V^\prime} \qty(W^\prime \circ W^\prime \subset W \circ W \subset V \subset V^\prime)$である。

  \vskip\baselineskip

  第五式を考える。$\forall V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \exists W \in \mathcal{V} \exists W^\prime \in \mathcal{V^\prime} \qty(W^\prime \subset V^\prime \subset V^{-1} \subset V^{\prime -1})$である。

  \vskip\baselineskip

  $\forall U \in \mathcal{U} \exists V \in \mathcal{V} \exists V^\prime \in \mathcal{V^\prime} \qty(V^\prime \subset V \subset U)$である。ゆえに、$U \in \mathcal{U^\prime}$である。

  $\forall U^\prime \in \mathcal{U^\prime} \exists V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \qty(V \subset V^\prime \subset U^\prime)$である。ゆえに、$U^\prime \in \mathcal{U}$である。
}
...
\thm{基本近縁系から定まる位相}{
  ...
  $\forall N \in \mathcal{N}(x)$について$\exists V \in \mathcal{V} \qty(V[x] \subset N)$であり、$U = V \cup \qty{\qty(x, y) \mid y \in N} \in \mathcal{U}$かつ$N = U[x]$であるので、$N \in \mathcal{N^\prime}(x)$

  $\forall N^\prime \in \mathcal{N^\prime}(x)$について$\exists U \subset X \times X \exists V \in \mathcal{V} \qty(V \subset U \land U[x] = N^\prime)$であり、$V[x] \subset U[x] = N^\prime \in \mathcal{N}(x)$
}
...
\lem{基本近縁系と一様連続}{
  ...
  $\forall V^\prime \in \mathcal{V^\prime} \subset \mathcal{U^\prime} \exists U \in \mathcal{U} \exists V \in \mathcal{V} \qty(\qty(x, y) \in V \subset U \rightarrow \qty(f(x), f(y)) \in V^\prime)$より明らか。

  \vskip\baselineskip

  $2. \rightarrow 1.$を示す。

  $\forall U^\prime \in \mathcal{U^\prime} \exists V^\prime \in \mathcal{V^\prime} \exists V \in \mathcal{V} \subset \mathcal{U} \qty(\qty(x, y) \in V \rightarrow \qty(f(x), f(y)) \in V^\prime \subset U^\prime)$より明らか。
}
...
\thm{一様連続は連続}{
  ...
  今、$U[x] \in \mathcal{N}(x)$であり、$f(U[x]) \subset U^\prime[f(x)] = N^\prime$より点連続。
...
\lem{一様連続とCauchy}{
  ...
  一様連続性から、$\exists U \in \mathcal{U} \qty(\qty(x, y) \in U \rightarrow \qty(f(x), f(y)) \subset U^\prime)$である。
...
\dfn{全有界}{
  ...
  \eq*{
    \forall U \in \mathcal{U} \exists A \subset X \qty(\abs{A} < \infty \land \bigcup \qty{U[x] \mid x \in A} = X)
  }
}
...
\thm{ネットによる全有界の特徴づけ}{
  ...
  \begin{enumerate}
    \item $X$は全有界
    \item $\forall V \in \mathcal{V} \exists A \subset X \qty(\abs{A} < \infty \land \bigcup \qty{V[x] \mid x \in A} = X)$
  ...
  $P \coloneqq \qty{A \subset X \mid \abs{A} < \infty \land A \neq \varnothing}$について、$\qty(P, \subset)$は有向集合であり、
...
\thm{Heine-Cantorの定理}{
  ...
  $\forall V^\prime \in \mathcal{V^\prime}$について、\lemref{基本近縁系の三角性}より$\exists W^\prime \in \mathcal{V^\prime} \qty(W^{\prime -1} \circ W^\prime \subset V^\prime)$

  \thmref{連続と点連続}から$\forall x \in X \exists V \in \mathcal{V} \qty(f(V[x]) \subset W^\prime[f(x)])$である。

  \dfnref{基本近縁系}第四式より$\exists W \in \mathcal{V} \qty(W \circ W \subset V)$

  今、$\qty{W(V^\prime, x)[x] \mid x \in X}$は被覆である。

  全有界性から$\exists Y \subset X \land \abs{Y} < \infty$であり$C \coloneqq \qty{W(V^\prime, x)[x] \mid x \in Y}$は被覆となる。

  \dfnref{基本近縁系}第三式より$S \coloneqq \bigcap \qty{W(V^\prime, x) \mid x \in Y} \in \mathcal{V}$である。

  \vskip\baselineskip

  $\forall \qty(w, z) \in S(V^\prime)$について、$C$は被覆より$\exists y \in Y(V^\prime) \qty(w \in W(V^\prime, y)[y] \subset V(V^\prime, y)[y])$である。

  $\qty(y, w), \qty(w, z) \in W(V^\prime, y)$であり、$\qty(y, z) \in V(V^\prime, y)$すなわち$z \in V(V^\prime, y)[y]$である。

  $w, z \in V(V^\prime, y)[y]$より$f(w), f(z) \in f(V(V^\prime, y)[y]) \subset W^\prime(V^\prime)[f(y)]$である。
