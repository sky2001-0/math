...
\lem{無限系譜の共通部分は無限系譜}{
  ...
  $\forall x \in \bigcap A$について、$\forall X \in A \qty(x \in X)$であり、無限系譜であることから$x^+ \in X$である。
...
\thm{最小無限系譜の一意性}{
  ...
  この集合は、無限系譜$X$の取り方によらずに一意に定まる。
}{
  $A \coloneqq \qty{Y \subset X \mid \text{$Y$は無限系譜である}}$とすると、
  $X \in A$より、$A \neq \varnothing$である。

  \lemref{無限系譜の共通部分は無限系譜}より成り立つ。
  ...
  \lemref{無限系譜の共通部分は無限系譜}より$X_1 \cap X_2$も無限系譜であり、定義より$\omega(X_2) \subset X_1 \cap X_2 \subset X_1$である。
