...
\begin{center}
  ...
  \begin{minipage}{0.5\linewidth}
    ...
    \begin{tikzcd}
      ...
      G(F(a)) \ar[rr, crossing over, "G(F(f))"] \ar[dd, "G(\eta(a))"'] \ar[ur, "\theta(F(a))"] \ar[rd, "\qty(\theta \ast \eta)(a)", red] & & G(F(b)) \ar[ur, "\theta(F(b))"'] \ar[rd, "\qty(\theta \ast \eta)(b)", red] \\
...
\begin{center}
  \begin{minipage}{0.5\linewidth}
    $\bm{E}$ \\
    \begin{tikzcd}
      G(F(a)) \ar[r, "\eta(F(a))"] \ar[d, "G(\sigma(a))"'] \ar[dd, bend right=90, red, "G\qty((\tau \circ \sigma)(a))"'] \ar[rd, red, "(\eta \ast \sigma) (a)"] & G^\prime(F(a)) \ar[r, "\theta(F(a))"] \ar[d, "G^\prime(\sigma(a))"] & G^{\prime \prime}(F(a)) \ar[d, "G^{\prime \prime}(\sigma(a))"] \\
      G(F^\prime(a)) \ar[r, "\eta(F^\prime(a))"] \ar[d, "G(\tau(a))"'] & G^\prime(F^\prime(a)) \ar[r, "\theta(F^\prime(a))"] \ar[d, "G^\prime(\tau(a))"] \ar[rd, red, "(\theta \ast \tau) (a)"] & G^{\prime \prime}(F^\prime(a)) \ar[d, "G^{\prime \prime}(\tau(a))"] \\
...
\dfnf{圏$\bm{\rightarrow \leftarrow}$}{スパン圏}{
...
\dfn{小さい圏}{
  圏$\bm{C}$について、集合$A$が存在して、$A$と$\bm{C}$が圏同型であるとき、$\bm{C}$は小さいと呼ぶ。
}
...
\lem{随伴は随伴関手}{
  ...
  $\bm{D}$の対象$y$と、$\bm{C}$の射$f$であって$\dom(f) = F(y) \land \cod(f) = a$を満たすものを考える。
  ...
  次に、$\bm{D}$の射$g^\prime, \dom(g^\prime) = y \land \cod(g^\prime) = G(a)$が存在して、$f = \theta(a) \circ F(g^\prime)$であるとする。
