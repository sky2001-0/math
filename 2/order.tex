...
\cor*{
  集合$P$について、$\qty(P, \subseteq)$は半順序集合である。また、$\qty(P, \supset)$も半順序集合である。
}
...
\thmf{Cantor-Schr\"{o}der-Bernsteinの定理}{Cantor-Schroder-Bernsteinの定理}{
  ...
  $X \subseteq Y \subseteq A$について、\lemref{像の性質}より$f(X) \subseteq f(Y)$であり、$B \setminus f(X) \supset B \setminus f(Y)$であり、
  \lemref{像の性質}より$g\qty(B \setminus f(X)) \supset g\qty(B \setminus f(Y))$であり、$F(X) \subseteq F(Y)$である。
