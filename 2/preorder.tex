...
\dfn{薄い圏}{
  ...
  \eq*{
    \forall a, b \in \Obj_{\bm{\Lambda}} \forall f, g \in \Hom[\bm{\Lambda}](a, b) \qty(f = g)
  }
}
...
\dfn{大小}{
  ...
  \eq*{
    a \preccurlyeq_{\bm{\Lambda}} b \defiff a \in \Obj_{\bm{\Lambda}} \land b \in \Obj_{\bm{\Lambda}} \land \exists f \in \Hom[\bm{\Lambda}](a, b)
  }
}
